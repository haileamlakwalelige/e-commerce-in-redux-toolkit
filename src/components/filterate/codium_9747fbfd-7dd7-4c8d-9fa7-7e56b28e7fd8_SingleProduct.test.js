...
describe('SingleProduct', () => {
    ...
    // Displays the product image, name, type, description, and price
    it('should display the product details correctly', () => {
      ...
      useSelectorMock.mockReturnValue([{ id: '1', name: 'Product 1', type: 'Type 1', text: 'Description 1', price: 10, img: 'image.jpg' }]);
      ...
      expect(wrapper.find('img').prop('src')).toEqual('image.jpg');
      expect(wrapper.find('h1').text()).toEqual('Product 1');
      expect(wrapper.find('.font-bold').at(0).text()).toEqual('Cloth Type:');
      expect(wrapper.find('.font-bold').at(1).text()).toEqual('Description:');
      expect(wrapper.find('.text-lg').at(1).text()).toEqual('Description 1');
      expect(wrapper.find('.bg-green-500').text()).toEqual('$10');
    });
});
